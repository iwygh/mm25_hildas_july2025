...
for iobj in range(nobj):
    ...
    del sim
    sim = None
np.savetxt('b003_' + famstr + '_aau_' + yrsstr + '.csv',aau_mat,delimiter=',')
np.savetxt('b003_' + famstr + '_e_' + yrsstr + '.csv',e_mat,delimiter=',')
np.savetxt('b003_' + famstr + '_ideg_' + yrsstr + '.csv',ideg_mat,delimiter=',')
np.savetxt('b003_' + famstr + '_perideg_' + yrsstr + '.csv',wdeg_mat,delimiter=',')
np.savetxt('b003_' + famstr + '_nodedeg_' + yrsstr + '.csv',Wdeg_mat,delimiter=',')
np.savetxt('b003_' + famstr + '_Mdeg_' + yrsstr + '.csv',Mdeg_mat,delimiter=',')
t1 = time.time()
print((t1-t0)/60)
#%%
