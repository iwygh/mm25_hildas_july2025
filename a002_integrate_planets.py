...
np.savetxt('b002_tyrsvec_' + yrsstr + '.csv',tyrsvec,delimiter=',')
GM_sun = 1
...
del sim
del starting_sim
np.savetxt('b002_planets_aau_' + yrsstr + '.csv',aau_mat_planets,delimiter=',')
np.savetxt('b002_planets_e_' + yrsstr + '.csv',e_mat_planets,delimiter=',')
np.savetxt('b002_planets_ideg_' + yrsstr + '.csv',ideg_mat_planets,delimiter=',')
np.savetxt('b002_planets_perideg_' + yrsstr + '.csv',wdeg_mat_planets,delimiter=',')
np.savetxt('b002_planets_nodedeg_' + yrsstr + '.csv',Wdeg_mat_planets,delimiter=',')
np.savetxt('b002_planets_Mdeg_' + yrsstr + '.csv',Mdeg_mat_planets,delimiter=',')
#%%
...
for it in range(nt):
    ...
    pT_vec[it] = pT
    sT_vec[it] = sT
np.savetxt('b002_planets_xinvar_' + yrsstr + '.csv',qT_vec,delimiter=',')
np.savetxt('b002_planets_yinvar_' + yrsstr + '.csv',pT_vec,delimiter=',')
