...
ideg_mat_planets = np.loadtxt('b002_planets_ideg_'+yrsstr+'.csv',delimiter=',')
...
for obj_name in obj_list:
    ...
    aau0_vec[0] = aau0
    np.savetxt('b004_'+obj_name+'_aau0_clones.csv',aau0_vec,delimiter=',')
    ...
    for iclone in range(nclones):
        ...
        del sim
        sim = None
    np.savetxt('b004_' + obj_name + '_aau_clones_' + yrsstr + '.csv',aau_mat,delimiter=',')
    np.savetxt('b004_' + obj_name + '_e_clones_' + yrsstr + '.csv',e_mat,delimiter=',')
    np.savetxt('b004_' + obj_name + '_ideg_clones_' + yrsstr + '.csv',ideg_mat,delimiter=',')
    np.savetxt('b004_' + obj_name + '_perideg_clones_' + yrsstr + '.csv',wdeg_mat,delimiter=',')
    np.savetxt('b004_' + obj_name + '_nodedeg_clones_' + yrsstr + '.csv',Wdeg_mat,delimiter=',')
    np.savetxt('b004_' + obj_name + '_Mdeg_clones_' + yrsstr + '.csv',Mdeg_mat,delimiter=',')
t1 = time.time()
print((t1-t0)/60)
