...
Wmat_planets = np.loadtxt('b002_planets_nodedeg_'+yrsstr+'.csv',delimiter=',')
wmat_planets = np.loadtxt('b002_planets_perideg_'+yrsstr+'.csv',delimiter=',')
Mmat_planets = np.loadtxt('b002_planets_Mdeg_'+yrsstr+'.csv',delimiter=',')
imat_planets = np.loadtxt('b002_planets_ideg_'+yrsstr+'.csv',delimiter=',')
emat_planets = np.loadtxt('b002_planets_e_'+yrsstr+'.csv',delimiter=',')
amat_planets = np.loadtxt('b002_planets_aau_'+yrsstr+'.csv',delimiter=',')
